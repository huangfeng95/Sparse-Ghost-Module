...
- Write network configuration yaml files based on your needs, or simply use [yolov5l-sparseghost](https://github.com/huangfeng95/Sparse-Ghost-Module/blob/main/yolov5l-sparseghost.yaml).
